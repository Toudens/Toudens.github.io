...
{{< hextra/feature-grid >}}
  ...
  {{< hextra/feature-card 
    title="数理方法" 
    subtitle="学不明白的数学与不讲道理的物理" 
    link="/phymath" 
    class="aspect-auto md:aspect-[1.1/1] max-md:min-h-[300px]" 
    image="images/phymath.webp" 
  ...
  {{< hextra/feature-card 
    title="通识课程" 
    subtitle="所谓常识就是常人不知道的知识" 
    link="/gened" 
    class="aspect-auto md:aspect-[1.1/1] max-md:min-h-[300px]" 
    image="images/gened.webp" 
...
<figure style="margin: 1rem auto; text-align: center;">
  <img src="/images/Tou.jpg" alt="偷一偷" style="width: 100%; max-width: 800px; display: block; margin: 0 auto; border-radius: 12px;" />
