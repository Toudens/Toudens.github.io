...
$$\begin{aligned}S(x)=\begin{cases}f(x)&当 x 是 f(x) 的连续点时;\\\begin{aligned}\frac{f(x-0)+f(x+0)}{2}\end{aligned}&当 x 是 f(x) 的第一类间断点时;\\\begin{aligned}\frac{f(-l+0)+f(l-0)}{2}\end{aligned}&当 x=\pm l\end{cases}\end{aligned}$$
